...
public class EstadisticasJugador {
    ...
    private int dineroInvertido;//done
    private int pagoDeAlquileres;//done
    private int cobroDeAlquileres;//done
    private int dineroPasoPorSalida;//Done
    private int inversionesBote;//TODO completar cuando esten las cartas
    private int vecesCarcel;//done
    private int pagoTasas;//TODO completar cuando esten las cartas
