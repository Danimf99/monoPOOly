...
public class ProcesarComando {
    ...
    * */
    ...
    public static void lanzarDados(String[] args/* Argumentos a mayores que se necesiten */) {

    }

    public static void describir(String[] args/* Argumentos a mayores que se necesiten */) {

    }

    public static void listar(String[] args/* Argumentos a mayores que se necesiten */) {
    ...
    public static void infoJugador(String[] args/* Argumentos a mayores que se necesiten */) {
